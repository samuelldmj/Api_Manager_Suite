...
class UserValidation
{
  ...
  {
    $schemaValidator = v::attribute('first', v::stringType()->length(self::MINIMUM_NAME_LENGTH, self::MAXIMUM_NAME_LENGTH))
      ...
      ->attribute('password', v::stringType()->length(self::MINIMUM_PASSWORD_LENGTH), mandatory: false)
  ...
  {
    $schemaValidator = v::attribute('email', v::email(), mandatory: false)
